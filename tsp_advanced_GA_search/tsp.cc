...
// The best cities permutation is returned.
Cities::permutation_t
ga_search_climb(const Cities& cities,
          unsigned iters,
          unsigned pop_size,
...
Cities::permutation_t
ga_search_tournament(const Cities& cities,
          unsigned iters,
          unsigned pop_size,
          double mutation_rate)
{
...
int main(int argc, char** argv)
{
  ...
  //  const auto best_ordering = ga_search_climb(cities, NUM_ITER, pop_size, mut_rate);
   const auto best_ordering = ga_search_tournament(cities, NUM_ITER, pop_size, mut_rate);
